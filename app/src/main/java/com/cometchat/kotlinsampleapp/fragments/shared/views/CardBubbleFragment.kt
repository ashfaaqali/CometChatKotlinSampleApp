...
class CardBubbleFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val cardBubbleStyle = CardBubbleStyle()
            ...
            .setContentBackgroundColor(theme.palette.background)
            .setCornerRadius(16f)
            .setProgressBarTintColor(theme.palette.primary)
            .setButtonSeparatorColor(theme.palette.accent100)
            .setButtonBackgroundColor(theme.palette.background)
            .setButtonTextColor(theme.palette.primary)
            .setButtonDisableTextColor(theme.palette.accent500)
